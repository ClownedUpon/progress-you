...
var WALKTHROUGH_STEPS = [
  ...
  { target:null, view:"trackers", title:"Trackers", body:"Track anything: habits (did you run?), tallies (glasses of water), ratings (mood 1\u20135), measures (weight in kg), or choices (today's weather). Streaks, monthly grid, and trend charts included.", position:"center" },
